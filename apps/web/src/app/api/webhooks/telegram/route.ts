  ...
  if (message.text?.startsWith("/start")) {
    await sendMessage({
      ...
      text: [
        ...
        "• PDFs de fatura/extrato \\(anexe como documento\\)",
        "• *CSV ou OFX exportado do banco* — exata e instantânea ⚡",
        "",
        "_Bancos com CSV/OFX: Nubank, Itaú, Bradesco, Inter, C6, Santander_",
      ].join("\n"),
